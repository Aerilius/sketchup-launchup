...
class Translate
  ...
  #
  # @returns [Hash-like] a class instance from which strings can be fetched like from a Hash.
  #
  ...
  #
  # @returns [Hash] key/value pairs of original and translated strings
  #
  def get_all
    return @strings
  end
      ...
      AE.Translate = function(self) {
        ...
        self.get = function(text, s1, s2) {
          try {
            ...
            var value = STRINGS[key] || STRINGS[key = key.replace(/[\\.\\:]$/, "")];
